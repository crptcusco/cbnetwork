...
#SBATCH --ntasks-per-node=16 # Número de tarefas por Nó
#SBATCH --ntasks=48          # Número total de tarefas
...
cd /scratch/deephash/carlos.tovar/cbnetwork/experiments/2_networks_circular

echo "Starting Test Script"
export PYTHONPATH=/scratch/deephash/carlos.tovar/cbnetwork/:$PYTHONPATH
echo $PYTHONPATH
python3 exp2_circular_aleatory.py
